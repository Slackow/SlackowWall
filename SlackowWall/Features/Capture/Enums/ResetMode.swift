    ...
    var description: String {
        switch self {
            case .wall:
                ...
                • Your [OBS](0) "Run Instance" hotkey should include: "\(getKeyName(\.runKey))" and "\(getKeyName(\.resetOthersKey))".
            ...
            case .lock:
                ...
                • Your [OBS](0) "Run Instance" hotkey should include: "\(getKeyName(\.runKey))", "\(getKeyName(\.resetOthersKey))", "\(getKeyName(\.resetGKey))".
                • Your [OBS](0) "Switch to scene" hotkey should be: "\(getKeyName(\.resetGKey))".
                """
            case .multi:
                """
