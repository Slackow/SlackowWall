...
enum ResetMode: String, SettingsOption {
    ...
    var description: String {
        switch self {
            case .wall:
                ...
                • Your [OBS](0) "Switch to scene" hotkey should be: \
                "\(getKeyName(\.resetGKey))".
                """
            case .lock:
                """
    ...
    private func getKeyName(_ code: KeyPath<Preferences.KeybindSection, Keybinding>) -> String {
        return Settings[\.keybinds][keyPath: code].displayName
    }
}
